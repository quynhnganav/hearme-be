...
export class PostService implements BaseService<Post, PostDocument, {}, {}>{
    ...
    updateOne(args: { filter?: _FilterQuery<_AllowStringsForIds<Pick<_LeanDocument<PostDocument>, "_id" | "__v" | "id" | "text" | "medias" | "likes" | "isDeleted" | "isLocked" | "isActive" | "createdBy" | "createdAt" | "updatedBy" | "updatedAt">>>; update: {}; context?: any; }): Promise<Post> {
        throw new Error("Method not implemented.");
    }
